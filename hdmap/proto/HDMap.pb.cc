...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<3> scc_info_HDMap_HDMap_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 3, InitDefaultsscc_info_HDMap_HDMap_2eproto}, {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(mutable_scene_id(), ptr, ctx, "hdmap.HDMap.scene_id");
          CHK_(ptr);
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 42)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(mutable_version(), ptr, ctx, "hdmap.HDMap.version");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
::PROTOBUF_NAMESPACE_ID::uint8* HDMap::InternalSerializeWithCachedSizesToArray(
  ...
  for (unsigned int i = 0,
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessageToArray(
        3, this->tafficlights(static_cast<int>(i)), target);
  }
  ...
  for (unsigned int i = 0,
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessageToArray(
        4, this->lanemarkings(static_cast<int>(i)), target);
  }
...
void HDMap::InternalSwap(HDMap* other) {
  ...
  CastToBase(&tafficlights_)->InternalSwap(CastToBase(&other->tafficlights_));
  CastToBase(&lanemarkings_)->InternalSwap(CastToBase(&other->lanemarkings_));
