    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "hdmap.Divider.geometry"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // int32 color = 3;
...
::PROTOBUF_NAMESPACE_ID::uint8* Divider::_InternalSerialize(
  ...
  if (this->occlusion() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(5, this->_internal_occlusion(), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:hdmap.Divider)
  ...
  if (from.occlusion() != 0) {
    _internal_set_occlusion(from._internal_occlusion());
  }
}
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ...
          do {
            ptr += 1;
            ptr = ctx->ParseMessage(_internal_add_dividers(), ptr);
            CHK_(ptr);
...
::PROTOBUF_NAMESPACE_ID::uint8* DividerPerFrame::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  ...
  for (unsigned int i = 0,
      n = static_cast<unsigned int>(this->_internal_dividers_size()); i < n; i++) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(2, this->_internal_dividers(i), target, stream);
  }
...
// @@protoc_insertion_point(message_byte_size_start:hdmap.DividerPerFrame)
  ...
  // repeated .hdmap.Divider dividers = 2;
  total_size += 1UL * this->_internal_dividers_size();
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "hdmap.DividerPerCapture.scene_id"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ...
          do {
            ptr += 1;
            ptr = ctx->ParseMessage(_internal_add_divider_frames(), ptr);
            CHK_(ptr);
            if (!ctx->DataAvailable(ptr)) break;
          } while (::PROTOBUF_NAMESPACE_ID::internal::ExpectTag<18>(ptr));
        } else goto handle_unusual;
...
::PROTOBUF_NAMESPACE_ID::uint8* DividerPerCapture::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  ...
  // repeated .hdmap.DividerPerFrame divider_frames = 2;
  for (unsigned int i = 0,
      n = static_cast<unsigned int>(this->_internal_divider_frames_size()); i < n; i++) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(2, this->_internal_divider_frames(i), target, stream);
  }
...
// @@protoc_insertion_point(message_byte_size_start:hdmap.DividerPerCapture)
  ...
  // repeated .hdmap.DividerPerFrame divider_frames = 2;
  total_size += 1UL * this->_internal_divider_frames_size();
