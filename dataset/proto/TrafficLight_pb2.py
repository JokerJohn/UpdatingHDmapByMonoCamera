...
TrafficLightPerFrame = _reflection.GeneratedProtocolMessageType('TrafficLightPerFrame', (_message.Message,), {
...
TrafficLightPerCapture = _reflection.GeneratedProtocolMessageType('TrafficLightPerCapture', (_message.Message,), {
