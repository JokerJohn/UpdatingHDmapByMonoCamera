    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "hdmap.HDMap.scene_id"));
          CHK_(ptr);
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 26)) {
          ...
          do {
            ptr += 1;
            ptr = ctx->ParseMessage(_internal_add_tafficlights(), ptr);
            CHK_(ptr);
            if (!ctx->DataAvailable(ptr)) break;
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 34)) {
          ...
          do {
            ptr += 1;
            ptr = ctx->ParseMessage(_internal_add_lanemarkings(), ptr);
            CHK_(ptr);
            if (!ctx->DataAvailable(ptr)) break;
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 42)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "hdmap.HDMap.version"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
::PROTOBUF_NAMESPACE_ID::uint8* HDMap::_InternalSerialize(
  ...
  // repeated .hdmap.TrafficLight tafficlights = 3;
  for (unsigned int i = 0,
      n = static_cast<unsigned int>(this->_internal_tafficlights_size()); i < n; i++) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(3, this->_internal_tafficlights(i), target, stream);
  }

  // repeated .hdmap.LaneMarking lanemarkings = 4;
  for (unsigned int i = 0,
      n = static_cast<unsigned int>(this->_internal_lanemarkings_size()); i < n; i++) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(4, this->_internal_lanemarkings(i), target, stream);
  }
...
// @@protoc_insertion_point(message_byte_size_start:hdmap.HDMap)
  ...
  // repeated .hdmap.TrafficLight tafficlights = 3;
  total_size += 1UL * this->_internal_tafficlights_size();
  ...
  // repeated .hdmap.LaneMarking lanemarkings = 4;
  total_size += 1UL * this->_internal_lanemarkings_size();
