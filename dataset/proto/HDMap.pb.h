...
class HDMap :
 ...
 public:
  ...
  private:
  int _internal_tafficlights_size() const;
  public:
  ...
  private:
  const ::hdmap::TrafficLight& _internal_tafficlights(int index) const;
  ::hdmap::TrafficLight* _internal_add_tafficlights();
  public:
  ...
  private:
  int _internal_lanemarkings_size() const;
  public:
  ...
  private:
  const ::hdmap::LaneMarking& _internal_lanemarkings(int index) const;
  ::hdmap::LaneMarking* _internal_add_lanemarkings();
  public:
...
// repeated .hdmap.Divider dividers = 2;
inline int HDMap::_internal_dividers_size() const {
...
inline const ::hdmap::Divider& HDMap::_internal_dividers(int index) const {
...
inline ::hdmap::Divider* HDMap::_internal_add_dividers() {
...
// repeated .hdmap.TrafficLight tafficlights = 3;
inline int HDMap::_internal_tafficlights_size() const {
  return tafficlights_.size();
}
inline int HDMap::tafficlights_size() const {
  return _internal_tafficlights_size();
}
...
inline const ::hdmap::TrafficLight& HDMap::_internal_tafficlights(int index) const {
...
inline const ::hdmap::TrafficLight& HDMap::tafficlights(int index) const {
  ...
  return _internal_tafficlights(index);
}
inline ::hdmap::TrafficLight* HDMap::_internal_add_tafficlights() {
...
inline ::hdmap::TrafficLight* HDMap::add_tafficlights() {
  ...
  return _internal_add_tafficlights();
}
...
// repeated .hdmap.LaneMarking lanemarkings = 4;
inline int HDMap::_internal_lanemarkings_size() const {
  return lanemarkings_.size();
}
inline int HDMap::lanemarkings_size() const {
  return _internal_lanemarkings_size();
}
...
inline const ::hdmap::LaneMarking& HDMap::_internal_lanemarkings(int index) const {
...
inline const ::hdmap::LaneMarking& HDMap::lanemarkings(int index) const {
  ...
  return _internal_lanemarkings(index);
}
inline ::hdmap::LaneMarking* HDMap::_internal_add_lanemarkings() {
...
inline ::hdmap::LaneMarking* HDMap::add_lanemarkings() {
  ...
  return _internal_add_lanemarkings();
}
