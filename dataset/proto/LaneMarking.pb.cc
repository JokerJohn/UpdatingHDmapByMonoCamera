    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "hdmap.LaneMarking.geometry"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // int32 type = 3;
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ...
          do {
            ptr += 1;
            ptr = ctx->ParseMessage(_internal_add_lane_markings(), ptr);
            CHK_(ptr);
...
::PROTOBUF_NAMESPACE_ID::uint8* LaneMarkingPerFrame::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  ...
  for (unsigned int i = 0,
      n = static_cast<unsigned int>(this->_internal_lane_markings_size()); i < n; i++) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(2, this->_internal_lane_markings(i), target, stream);
  }
...
// @@protoc_insertion_point(message_byte_size_start:hdmap.LaneMarkingPerFrame)
  ...
  // repeated .hdmap.LaneMarking lane_markings = 2;
  total_size += 1UL * this->_internal_lane_markings_size();
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "hdmap.LaneMarkingPerCapture.scene_id"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ...
          do {
            ptr += 1;
            ptr = ctx->ParseMessage(_internal_add_lane_marking_frames(), ptr);
            CHK_(ptr);
            if (!ctx->DataAvailable(ptr)) break;
          } while (::PROTOBUF_NAMESPACE_ID::internal::ExpectTag<18>(ptr));
        } else goto handle_unusual;
...
::PROTOBUF_NAMESPACE_ID::uint8* LaneMarkingPerCapture::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  ...
  // repeated .hdmap.LaneMarkingPerFrame lane_marking_frames = 2;
  for (unsigned int i = 0,
      n = static_cast<unsigned int>(this->_internal_lane_marking_frames_size()); i < n; i++) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(2, this->_internal_lane_marking_frames(i), target, stream);
  }
...
// @@protoc_insertion_point(message_byte_size_start:hdmap.LaneMarkingPerCapture)
  ...
  // repeated .hdmap.LaneMarkingPerFrame lane_marking_frames = 2;
  total_size += 1UL * this->_internal_lane_marking_frames_size();
