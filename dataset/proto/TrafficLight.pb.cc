    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "hdmap.Light.geometry"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // int32 direction = 3;
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          auto str = _internal_mutable_geometry();
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "hdmap.TrafficLight.geometry"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // int32 motor_type = 3;
...
::PROTOBUF_NAMESPACE_ID::uint8* TrafficLight::_InternalSerialize(
  ...
  if (this->motor_type() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(3, this->_internal_motor_type(), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:hdmap.TrafficLight)
  ...
  if (from.motor_type() != 0) {
    _internal_set_motor_type(from._internal_motor_type());
  }
}
...
::PROTOBUF_NAMESPACE_ID::uint8* TrafficLightPerFrame::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  ...
  for (unsigned int i = 0,
    ...
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(2, this->_internal_traffic_lights(i), target, stream);
  }
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "hdmap.TrafficLightPerCapture.scene_id"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ...
          do {
            ptr += 1;
            ptr = ctx->ParseMessage(_internal_add_traffic_light_frames(), ptr);
            CHK_(ptr);
            if (!ctx->DataAvailable(ptr)) break;
          } while (::PROTOBUF_NAMESPACE_ID::internal::ExpectTag<18>(ptr));
        } else goto handle_unusual;
...
::PROTOBUF_NAMESPACE_ID::uint8* TrafficLightPerCapture::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  ...
  // repeated .hdmap.TrafficLightPerFrame traffic_light_frames = 2;
  for (unsigned int i = 0,
      n = static_cast<unsigned int>(this->_internal_traffic_light_frames_size()); i < n; i++) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(2, this->_internal_traffic_light_frames(i), target, stream);
  }
...
// @@protoc_insertion_point(message_byte_size_start:hdmap.TrafficLightPerCapture)
  ...
  // repeated .hdmap.TrafficLightPerFrame traffic_light_frames = 2;
  total_size += 1UL * this->_internal_traffic_light_frames_size();
