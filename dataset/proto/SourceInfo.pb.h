...
class GPSPoint :
 ...
 public:
  ...
  private:
  ::PROTOBUF_NAMESPACE_ID::int64 _internal_gpstime() const;
  void _internal_set_gpstime(::PROTOBUF_NAMESPACE_ID::int64 value);
  public:
...
class GPSInfo :
 ...
 public:
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::source::GPSPoint >*
      mutable_pts();
  private:
  const ::source::GPSPoint& _internal_pts(int index) const;
  ::source::GPSPoint* _internal_add_pts();
  public:
...
inline ::PROTOBUF_NAMESPACE_ID::int32 GPSPoint::_internal_id() const {
  return id_;
}
...
inline void GPSPoint::_internal_set_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int64 GPSPoint::_internal_gpstime() const {
  return gpstime_;
}
inline ::PROTOBUF_NAMESPACE_ID::int64 GPSPoint::gpstime() const {
  // @@protoc_insertion_point(field_get:source.GPSPoint.gpstime)
  return _internal_gpstime();
}
inline void GPSPoint::_internal_set_gpstime(::PROTOBUF_NAMESPACE_ID::int64 value) {
  
  gpstime_ = value;
}
inline void GPSPoint::set_gpstime(::PROTOBUF_NAMESPACE_ID::int64 value) {
  _internal_set_gpstime(value);
...
inline double GPSPoint::_internal_heading() const {
  return heading_;
}
...
inline void GPSPoint::_internal_set_heading(double value) {
...
inline double GPSPoint::_internal_speed() const {
  return speed_;
}
...
inline void GPSPoint::_internal_set_speed(double value) {
...
inline double GPSPoint::_internal_accuracy() const {
  return accuracy_;
}
...
inline void GPSPoint::_internal_set_accuracy(double value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int32 GPSPoint::_internal_sum() const {
  return sum_;
}
...
inline void GPSPoint::_internal_set_sum(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
// repeated .source.GPSPoint pts = 3;
inline int GPSInfo::_internal_pts_size() const {
  return pts_.size();
}
...
inline const ::source::GPSPoint& GPSInfo::_internal_pts(int index) const {
...
inline ::source::GPSPoint* GPSInfo::_internal_add_pts() {
  return pts_.Add();
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 IMUInfo::_internal_id() const {
  return id_;
}
...
inline void IMUInfo::_internal_set_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int32 VideoInfo::_internal_id() const {
  return id_;
}
...
inline void VideoInfo::_internal_set_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
